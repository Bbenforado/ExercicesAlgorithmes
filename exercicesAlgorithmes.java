...
public class exercicesAlgorithmes {
	...
	public static void main(String[] args) {
		...
		while(!finish) {
			...
			//si afficherMenu est true, on affiche le menu
			if(afficherMenu) {
				//menu principal
	...
	//					//exercice 2
			...
			//si finish est false on demande si on recommence l'exercice ou si on retourne au menu
			if(!finish) {	
				...
				if(reponse == 2) {
					//on donne la valeur true à afficherMenu pour que le menu s'affiche
					afficherMenu = true;
				}
			}
